...
public class RopeCreatorWeighted : RopeCreator {
    ...
    {
        RopeSection weight1 = Instantiate(weightPrefab, rope.sections[0].transform.position - Vector3.right*0.2f, Quaternion.identity);
        ...
        RopeSection weight2 = Instantiate(weightPrefab, rope.sections[numSections - 1].transform.position + Vector3.right * 0.2f, Quaternion.identity);
